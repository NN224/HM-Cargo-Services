    ...
    <footer className="relative border-t border-[color:var(--border)] bg-[#050607] pt-20 pb-10">
      <div className="mx-auto max-w-[1440px] px-6 lg:px-10">
        <div className="grid gap-14 lg:grid-cols-[1.4fr_1fr_1fr_1fr]">
          <div>
            <img src={fullLogo} alt="HM Cargo Services" width={220} height={220} className="h-28 w-auto object-contain" />
            <p className="mt-6 max-w-sm text-sm leading-relaxed text-muted-foreground">
              Moving cargo forward. Reliable logistics, clear visibility, and careful handling from origin to destination.
            </p>
            <p className="eyebrow mt-6">Contact</p>
            <ul className="mt-3 space-y-1 text-sm text-muted-foreground">
              <li>Office 404, Awqaf Building, Street 8, Al Murar, Deira, Dubai, UAE</li>
              <li>
                <a href="tel:+96181059063" className="transition-colors hover:text-foreground">
                  +961 81 059 063
                </a>
              </li>
              <li>
                <a href="tel:+971521530190" className="transition-colors hover:text-foreground">
                  +971 52 153 0190
                </a>
              </li>
              <li>
